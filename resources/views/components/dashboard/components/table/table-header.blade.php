          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                {{-- @foreach ($buttons as $element => $props)
                <{!!$element!!} {!!$element === 'a' ? 'href="'.$props['href'].'"' : 'type="'.$props['type'].'"'!!} class="{{ $props['class'] ?? 'py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none'}}" 
                ...
                @php
                    ...
                    $class = $button['class'] ?? 'py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none';
                    $icon = $button['icon'] ?? '';
